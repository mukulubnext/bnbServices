    ...
    <section className="relative h-screen flex bg-dark items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <p className="text-xl md:text-2xl leading-relaxed font-light text-muted">
          We bridge the gap between innovation and reality. Our deep green roots
          represent stability, while our light-speed tools empower you to reach
          the summit of your digital ambitions.
        </p>
