      ...
      <div className="relative max-w-7xl mx-auto px-6 text-center md:text-left w-full">
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link href={"/register"} className="px-8 py-4 rounded-full font-bold text-lg text-dark bg-light duration-300 hover:shadow-xl transition-all">
              Get Started
            </Link>
            <Link href={"/about"} className="px-8 py-4 bg-white/5 border-muted text-muted border rounded-full font-bold text-lg hover:bg-white/10 duration-300 transition-all">
              Learn More
            </Link>
          </div>
        </div>
